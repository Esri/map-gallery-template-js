...
$(document).ready(function() {
	...
	if(pmgConfig.showMoreInfo){
		...
		var mapURL = pmgConfig.arcgisPortalURL + 'home/item.html?id=' + webmap;
		// SHOW AND SET HREF
	...
	// If mobile user
	if(isMobileUser() && pmgConfig.appCookie == 'installed'){
		// get item url
		var itemURL = itemURL = getMobileAppURL(webmap);
		// add button
		$('#mapButtons').prepend('<a id="mobileAppButton" href="' + itemURL + '" class="mapButton buttonSingle">Open in mobile App</a>');
	}
	// SEARCH
